---
title: OpenCode Doesn't Have an Auto Mode. So I Built One with vLLM Semantic Router
pubDatetime: 2026-07-09T00:00:00Z
description: "Cursor picks the right model for you automatically. OpenCode doesn't - yet. Here's a complete, production-shaped guide to adding intelligent auto model selection to OpenCode (or any OpenAI-compatible agent) using vLLM Semantic Router and AgentGateway."
tags:
  - blog
---
...
┌──────────────────────────────────────────────────────┐
│                   OpenCode (TUI)                       │
│      custom provider → http://localhost:3000/v1        │
│                  model: "MoM"                          │
└─────────────────────────┬──────────────────────────────┘
                          │
                          ▼
...
│  3. Semantic Router embeds prompt, picks a model       │
│  4. Header mutation: x-selected-model: qwen-coder      │
...
<!-- AGENTGATEWAY UI SCREENSHOT GOES HERE -->
*[🖼️ Screenshot: AgentGateway UI — one OpenCode session fanning out across qwen2.5-coder, gpt-4o, and gemini-2.5-flash, with per-request tokens and cost]*
...
`#ai` `#agents` `#opencode` `#architecture` `#opensource`
